...
/**
 * \brief Solicita un ID al cliente y muestra todos sus datos
...
/**
 * \brief Solicita los datos al cliente por parametros para un alta forzada
 * \param array de datos
 * \param tamaño del array
...
/**
 * \brief Solicita el ID del cliente y busca la posicion de este en el array
 * \param array de datos
 * \param tamaño del array
 * \param ID del cliente
 * \return el numero de posicion que ocupa el cliente
 */
...
/**
 * \brief Solicita el ID del cliente y cambia el 'isEmpty' a 1
 * \param array de datos
 * \param tamaño del array
 * \param ID del cliente
 * \return 0 si se pudo realizar la tarea, si no el numero correspondiente al error
...
/**
 * \brief Muestra todos los clientes activos en el array
 * \param array de datos
 * \param tamaño del array
 * \return 0 si se pudo realizar la tarea, si no el numero correspondiente al error
 */
...
/**
 * \brief Solicita los datos al cliente  para un alta
 * \param array de datos
 * \param tamaño del array
 * \return 0 si se pudo realizar la tarea, si no el numero correspondiente al error
 */
...
/**
 * \brief Solicita ID al cliente para realizar modificacion de datos
 * \param array de datos
 * \param tamaño del array
 * \param ID del cliente
 * \return 0 si se pudo realizar la tarea, si no el numero correspondiente al error
...
/**
 * \brief Ordena por nombre los clientes en el array
 * \param array de datos
 * \param tamaño del array
