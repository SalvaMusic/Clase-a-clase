...
int main()
{
    ...
    controller_leerArchivoCliente("clientes.txt",pArrayClientes);
    ...
    do
    {
        ...
        switch(menu)
        {
            case 1:
                ...
                controller_guardarClienteArchivo(pArrayClientes,"clientes.txt");
                system("pause");
                break;
            case 2:
                printf("\n\tMODIFICAR DATOS CLIENTE:\n");
                controller_listarCliente(pArrayClientes);
            ...
            case 4:
                printf("\n\tLISTAR CLIENTES:\n");
                controller_listarClienteApellidoNombre(pArrayClientes);
                system("pause");
                break;
            case 5:
                printf("\n\tPAUSAR PUBLICACION:");
